...
### Retrieve an Entire Directory Item Tree

**URL parameters:**

<Callout icon="📝" theme="default">
  **Note:** This section describes the parameters of `/directory/v1/subtree/{scope}` endpoint.
</Callout>
...
<Callout icon="📋" theme="info">
  ...
  ```curl
  curl -X 'GET' \
    'https://api.prod.door.com/directory/v1/subtree/4a9fc553-e920-499b-92b1-fd08e7507b91?pageToken=&pageSize=10' \
    -H 'accept: */*' \
    -H 'Authorization: Bearer {token}'
  ```
</Callout>
