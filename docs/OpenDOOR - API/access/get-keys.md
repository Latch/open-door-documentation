...
A key typically represents access rules to one or more doors in a building. Both single-door keys generated by OpenDoor and DoorOS created keys assigned to the current partner will be retrieved.
